      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-cream/60 max-w-2xl mx-auto text-lg">
            Visit our stores in the iconic Naif Souq, Deira, Dubai &mdash; the heart of
            traditional textile trading in the UAE.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-cream/50 text-sm">Opposite Naif Souq, Gate No 3 & 4</p>
                </div>
              </div>
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-gold font-medium tracking-wider text-sm uppercase">Our Address</span>
          </div>
          <p className="text-cream/70 text-sm sm:text-base md:text-lg px-2">
            P.O. Box: 64765, Opposite Naif Souq, Gate No 3 &amp; 4, Deira, Dubai - UAE
          </p>
        </motion.div>
      </div>
    </section>
